...
// Sample data - personal ingredients
const personalIngredients: ExtendedIngredient[] = [
  { id: "1", name: "Tomatoes", quantity: 8, unit: "pcs", category: "Vegetables", expiryDate: "2026-02-05" },
  { id: "2", name: "Olive Oil", quantity: 500, unit: "ml", category: "Other", notes: "Extra virgin" },
  { id: "3", name: "Chicken Breast", quantity: 2, unit: "lb", category: "Meat", expiryDate: "2026-02-03" },
  { id: "4", name: "Basil", quantity: 1, unit: "pcs", category: "Vegetables", notes: "Fresh bunch" },
  { id: "5", name: "Parmesan", quantity: 200, unit: "g", category: "Dairy", expiryDate: "2026-03-15" },
  { id: "6", name: "Pasta", quantity: 500, unit: "g", category: "Grains" },
  { id: "7", name: "Garlic", quantity: 1, unit: "pcs", category: "Vegetables" },
  { id: "8", name: "Black Pepper", quantity: 50, unit: "g", category: "Spices" },
];
...
export default function Dashboard() {
  const [ingredients, setIngredients] = useState<ExtendedIngredient[]>(personalIngredients);
  ...
  const handleSave = (data: Omit<Ingredient, "id"> | Ingredient) => {
    if ("id" in data) {
      // Update existing
      setIngredients((prev) =>
        prev.map((ing) => (ing.id === data.id ? { ...data, isShared: false } : ing))
      );
    } else {
      // Add new

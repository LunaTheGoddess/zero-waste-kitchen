  ...
  return <>
      ...
      x: 0
        ...
        <div className="p-4 flex items-center gap-3">
          <img alt="Zero-Waste Kitchen Logo" className="h-10 w-10 rounded-lg object-contain flex-shrink-0" src={logo} />
          <AnimatePresence>
            {isOpen && <motion.div initial={{
            opacity: 0,
            x: -10
          ...
          <div className={cn("flex items-center gap-3 p-3 rounded-lg bg-sidebar-accent/50", !isOpen && "justify-center")}>
            ...
            <AnimatePresence>
              ...
              x: -10
                  ...
                  <p className="font-medium text-sm text-foreground truncate">Jane Doe</p>
